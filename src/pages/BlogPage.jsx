    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Economics Blog Series</h1>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-8">
            The Council brings you the Econ Blog. This blog series aims to keep you updated on 
            interesting topics related to Economics and Finance, and will give you exposure to 
            the various career opportunities they offer.
          </p>
        </div>
